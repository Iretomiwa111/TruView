...
export default function AboutPreview() {
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid items-center gap-16 lg:grid-cols-2">
          ...
          >
            ...
            <div className="mb-6 h-1 w-20 rounded-full bg-teal-400" />
  ...
  "
    ...
    "
            >
              <div className="mb-4 h-3 w-3 rounded-full bg-teal-400" />
    ...
    "
            >
              <div className="mb-4 h-3 w-3 rounded-full bg-cyan-400" />
