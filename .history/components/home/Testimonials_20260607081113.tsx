...
"
  ...
  "
              ...
              <Quote
                size={32}
                className="relative z-10 mb-6 text-teal-400"
              />
              ...
              <div className="relative z-10 mt-8 flex items-center gap-4">
                ...
                <div>
                 <div className="flex h-12 w-12 items-center justify-center rounded-full bg-gradient-to-br from-teal-400 to-cyan-500 text-sm font-bold text-slate-950">
  {testimonial.name
    .split(" ")
    .map((word) => word[0])
    .join("")}
